 ...
 * @constructor
 */
const InputField = ({ type, icon, flipIcon = false, placeholder, onChange }) => {
    return (
        <div className="relative block">
            ...
            <input
                ...
                className="w-full rounded-xl border-none bg-white py-2 pl-16 pr-4 text-sm shadow-md placeholder:opacity-50 focus:border-purple focus:outline-none focus:ring-1 focus:ring-purple"
                onChange={onChange}
            />
        </div>
    )
